...
curl -LSs "https://raw.githubusercontent.com/AzyrRuthless/KernelSU-Next/next/kernel/setup.sh" | bash -s next
...
git clone -q https://github.com/AzyrRuthless/AnyKernel3 "$AK3_DIR" || handle_error "Failed to clone AnyKernel3"
